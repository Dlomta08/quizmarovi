quizData = [
  {
    ...
    options: ["ერთს", "ორს", "სამს", "ოთხს", "ხუთს", "ექვსს"],
    correct: 0,
    tags: ["ფუნქციები"]
  },
  {
  ...
  {
    question: "მოცემულია ორი სფერო რადიუსებით $2$ და $3$ და ცენტრებით \\( O_1 \\) და \\( O_2 \\). ცენტრებს შორის მანძილია \\( O_1O_2 = 7 \\). სიბრტყე რომელიც ორივე სფეროს ეხება, \\( O_1O_2 \\) წრფეს გადაკვეთს \\( A \\) წერტილში. იპოვეთ ჩამოთვლილთაგან რისი ტოლი შეიძლება იყოს \\( AO_1 \\).",
