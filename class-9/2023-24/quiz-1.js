const quizData = [
  ...
  {
    question: 'ოთხკუთხედში დიაგონალების გატარებისას მიღებული ოთხი სამკუთხედიდან რომელიღაც სამის ფართობია $80;$ $32$ და $128$. იპოვეთ რა უმცირესი ფართობი შეიძლება ქონდეს ამ ოთხკუთხედს?',
  ...
  {
    question: '$ABC$ სამკუთხედში $B$ კუთხე $30^\\circ$-ის ტოლია. გავლებულია $AM$ და $CN$ სამაღლეები. იპოვეთ $NBM$ სამკუთხედის ფართობი, თუ $ABC$ სამკუთხედის ფართობი $24$-ის ტოლია.',
  ...
  {
    question: 'სამკუთხედის ორი კუთხე $30^\\circ$-ისა და $105^\\circ$-ის ტოლია, უმცირესი გვერდის სიგრძე $2$-ის ტოლია. იპოვეთ ამ სამკუთხედის ფართობი.',
  ...
  {
    question: '$𝒚 = 𝒇(𝒙)$ ფუნქცია $ox$ ღერძს კვეთს $12$ წერტილში, მათ შორის კორდინატთა სათავეში. კვეთის წერტილებიდან $7$ წერტილს $𝒙$ კორდინატი უარყოფითი აქვთ. იპოვეთ \\(f(|x|) = 0\\) განტოლების ამონახსნთა რაოდენობა.',
    options: ['$11$', '$7$', '$8$', '$10$', '$9$', 'შეუძლებელია დადგენა'],
    correct: 4,
    tags: ['მოდული']
  },
  {
    question: '$𝒇(𝒙) = 𝒂𝒙^2 + 𝒃𝒙 + 𝒄 $ ფუნქციის გრაფიკი მიიღება $𝒈(𝒙) = −𝒙^2 + 𝟒𝒙 − 𝟑$ ფუნქციის გრაფიკის ორი პარალელური გადატანით. კერძოდ აბცისათა ღერძის გასწვრივ უარყოფითი მიმართულებით $3$ ერთეულით გადატანით და ორდინატთა ღერძის გასწვრივ დადებითი მიმართულებით $4$ ერთეულით გადატანით. იპოვეთ $a+b+c$ მნიშვნელობა.',
    options: ['$1$', '$2$', '$0$', '$−3$', '$2$', '$ −1$'],
    correct: 0,
