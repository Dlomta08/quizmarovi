quizData = [
  ...
  {
    question: "$ABCD$ ტრაპეციაში დიაგონალების გადაკვეთის წერტილზე გავლებულია $BC$ და $AD$ ფუძეების პარალელური წრფე, რომელიც $AB$ და $CD$ ფერდებს შესაბამისად $E$ და $F$ წერტილებში კვეთს. იპოვეთ $EBCF$ და $AEFD$ ტრაპეციების ფართობთა შეფარდება, თუ $BC:AD = 1:2$.",
