quizData = [
  ...
  // 14
  {
    question: "$y = f(x)$ ფუნქციის განსაზღვრის არეა $\\mathbb{R}$ და ეს ფუნქცია დიფერენცირებადია (წარმოებადია) განსაზღვრის არის ნებისმიერ წერტილში. ცნობილია, რომ ნებისმიერი $x$-თვის $f^3(x) + x^2f(x) + 1 = x$. იპოვეთ $f'(1)$",
