const quizData = [
  ...
  // 2
  {
    question: "იპოვეთ $(a - b)^2$, &thinsp; თუ &thinsp; $a^{-1} + b^{-1} = 1{,}6$ &thinsp; და &thinsp; $a^{-1}b^{-1} = 0{,}2$.",
  ...
  // 16
  {
    question: "მოცემულია წილადი $\\frac{2m + 17}{m - 1}$. ეს წილადი ქვემოთ ჩამოთვლილი პასუხებიდან რომელ რიცხვზეა შესაძლებელი შეიკვეცოს?",
  ...
  // 19
  {
    question: "$A$ კუთხის შიგნით მდებარე $O$ წერტილიდან კუთხის გვერდებზე დაშვებულია $OC$ და $OB$ მართობები. იპოვეთ &thinsp; $\\angle ACB$, &thinsp; თუ &thinsp; $\\angle BAO = 48^\\circ$.",
